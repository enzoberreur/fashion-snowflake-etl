...
class MultiTableIngester:
    ...
    def ingest_sales_data(self, filename: str) -> int:
    ...
    def ingest_returns_data(self, filename: str) -> int:
    ...
    def ingest_reviews_data(self, filename: str) -> int:
    ...
    def ingest_inventory_data(self, filename: str) -> int:
